...
export default function Experiences() {
  ...
  return (
    <div id="projects" className='flex flex-col h-screen px-14 py-14'>
      ...
      <div ref={ref} className='keen-slider overflow-y-hidden min-h-fit h-full mb-10 flex flex-row overflow-x-hidden cursor-grab active:cursor-grabbing'>
        <div className='keen-slider__slide min-w-[85%] flex flex-row bg-[#51513D] rounded-lg mt-10'>
          <div className='flex flex-col items-center justify-between w-full sm:w-2/5 my-6 overflow-y-scroll'>
            <div className='flex flex-col'>
              <h4 className={`${inter.className} text-textPrimary text-xl mb-5 text-center`}>School projects</h4>
              <ul className='flex flex-col gap-2 list-disc text-textSecondary ml-8 pr-10 text-left'>
            ...
            <span className='text-textSecondary text-xs text-center'>Image from a Space Invader project made in one week in HTML/CSS/JS</span>
              <span className='text-textSecondary text-center'>September 2022 - Present</span>
            </div>
          </div>
          <div className='hidden sm:block rounded-r-lg w-3/4 bg-[url("/space-invader.png")] bg-no-repeat bg-cover bg-center'></div>
        </div>
        <div className='keen-slider__slide min-w-[85%] flex flex-row bg-[#51513D] rounded-lg mt-10'>
          <div className='flex flex-col items-center justify-between w-full sm:w-2/5 my-6 overflow-y-scroll'>
            ...
            <span className='text-textSecondary text-xs text-center'>Image from Shomp, an UberEats reduction appplier</span>
              <span className='text-textSecondary text-center'>April - June 2023</span>
            </div>
          </div>
          <div className='hidden sm:block rounded-r-lg w-3/4 bg-[url("/shomp.png")] bg-no-repeat bg-cover bg-center'></div>
        </div>
        <div className='keen-slider__slide min-w-[85%] flex flex-row bg-[#51513D] rounded-lg mt-10'>
          <div className='flex flex-col items-center justify-between w-full sm:w-2/5 my-6 overflow-y-scroll'>
            <div className='flex flex-col items-center'>
          ...
          <div className='hidden sm:block rounded-r-lg w-3/4 bg-[url("/scraper.png")] bg-no-repeat bg-cover'></div>
        </div>
        <div className='keen-slider__slide min-w-[85%] flex flex-row bg-[#51513D] rounded-lg mt-10'>
          <div className='flex flex-col items-center justify-between w-full sm:w-2/5 my-6 overflow-y-scroll'>
            <div className='flex flex-col items-center'>
              <h4 className={`${inter.className} text-textPrimary text-xl mb-5 mx-2 text-center`}>Loose projects / WIP</h4>
              <ul className='list-disc ml-8 text-textSecondary'>
                ...
                <li><span className='text-textPrimary text-lg'>Slash</span> : A host and schedule scripts in server-less</li>
              </ul>
            </div>
          ...
          <div className='hidden sm:block rounded-r-lg w-3/4 bg-[url("/code.jpg")] bg-no-repeat bg-cover'></div>
        </div>
      </div>
    </div>
  )
