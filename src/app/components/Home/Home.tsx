  ...
  return (
    <div className='flex flex-col min-h-screen'>
      ...
      <div className='absolute top-1/2 transform -translate-y-1/2 w-full text-center my-0 flex flex-col items-center gap-10'>
        <h1 className={`${lexend.className} text-textPrimary sm:text-7xl text-6xl text-shadow-lg`}>Full-Stack Developer</h1>
        <nav className='flex flex-col sm:flex-row gap-5 sm:gap-0 justify-between lg:w-[40%] w-[60%]'>
