  ...
  return (
    <div id="experiences" className='flex flex-col min-h-screen px-14 py-14'>
      ...
      <div className='flex flex-col sm:px-10'>
        ...
        <>
          <div className={`flex flex-col gap-4 sm:px-10 transform transition-transform duration-500 ease-in-out ${categeory !== 'company' && 'hidden transform transition-transform duration-500 ease-in-out'}`}>
          ...
          <div className={`flex flex-col gap-4 sm:px-10 transform transition-transform duration-500 ease-in-out ${categeory !== 'missions' && 'hidden transform transition-transform duration-500 ease-in-out'}`}>
          ...
          <div className={`flex flex-col gap-4 sm:px-10 transform transition-transform duration-500 ease-in-out ${categeory !== 'skills' && 'hidden transform transition-transform duration-500 ease-in-out'}`}>
